        ...
        <section className="overflow-x-auto rounded-xl border border-gray-200 bg-white dark:border-neutral-700 dark:bg-neutral-900">
            <table className="min-w-full">
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-neutral-800">
                    {report.rows.length === 0 && <tr><td colSpan={5} className="px-3 py-10 text-center text-sm text-gray-500 dark:text-neutral-400">No payments in this period<span className="mt-1 block text-xs text-gray-400 dark:text-neutral-500">Choose another preset or date range above.</span></td></tr>}
                    {report.rows.map((row) => (
