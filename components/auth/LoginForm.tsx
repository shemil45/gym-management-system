...
export type LoginFormProps = {
    ...
    signUp?: { prompt: string; href: string; label: string }
    /** Optional helper copy rendered below the card. */
    helperText?: React.ReactNode
    /** Where to send the browser once the session is established. */
    redirectTo?: string
}
            ...
            <div className="relative z-10">
                ...
                {helperText && (
                    <div className="mt-5 space-y-2 text-center">
                        <p className="text-xs text-[#76777d] dark:text-[#988e90]">{helperText}</p>
                    </div>
                )}
            </div>
        </div>
